//package com.angorasix.notifications.integration.docs
//
//import com.angorasix.notifications.ProjectsCoreApplication
...
//import com.angorasix.notifications.integration.utils.IntegrationProperties
//import com.angorasix.notifications.integration.utils.initializeMongodb
...
//class NotificationCoreDocsIntegrationTest(
...
//        val newProject = NotificationDto("New Project Name")
//        webTestClient.post()
//            .uri("/projects-core/")
...
//        val elementId = mongoTemplate.findOne(initElementQuery, Notification::class.java).block()?.id
//
...
//                    preprocessResponse(prettyPrint()),
//                    responseFields(
//                        fieldWithPath("[]").type(ArrayOfFieldType(Notification::class.simpleName))
